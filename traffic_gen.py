...
def main():
    ...
    parser.add_argument('latencies', type=int, nargs='+', help="List of hop latencies for each packet")
    args = parser.parse_args()

    if len(args.latencies) != args.num_packets:
        print("The number of latencies provided must match the number of packets to be sent.")
        exit(1)
