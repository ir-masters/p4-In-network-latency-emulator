...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Flag indicating whether to use CustomData (defaults to false). If only this flag is provided, custom_id is set to 101 by default",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="The hop latency of the custom content",
    )
